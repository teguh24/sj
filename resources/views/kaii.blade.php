...
<div class="container-full">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3"  style="border: 4px solid #a1a1a1;">
            <h2><center><font color="white">Scan Barcode -- Kirim AII</font></center></h2>
            <center>
                <form action="http://172.18.10.135/sj/public/aii" class="form-horizontal" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
